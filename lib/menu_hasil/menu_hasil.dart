...
class HasilProgram extends StatefulWidget {
  const HasilProgram({super.key});

  @override
  State<HasilProgram> createState() => _HasilProgramState();
}

class _HasilProgramState extends State<HasilProgram> {
